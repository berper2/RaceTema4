...
```{r}
#Se alamacenan los datos en un tibble y se borra el data frame que teníamos
cran <- as_tibble(mydf)
rm(mydf)
...
```{r}
#Primero muestra los datos y luego con el glimpse muestra un resumen con los tipos
#de cada columna y sus datos.
cran
glimpse(cran)
...
```{r}
cran %>%
  select(c(ip_id,package,country))

#Seleccionamos solo las tres variables indicadas
...
#Usamos los dos puntos para seleccionar un rango de columnas
